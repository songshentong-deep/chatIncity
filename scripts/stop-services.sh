...
echo ""
echo "🔍 最终检查..."
REMAINING_SERVICES=$(ps aux | grep -E "(user-service|auth-service|match-service|chat-service|content-service|location-service|notification-service|admin-service)" | grep -v grep)
